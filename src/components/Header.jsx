const Header = () => {
    return (
       ...
       <nav className="flex h-32 items-center justify-between">
        ...
        <ul className="fixed inset-0 bg-violet-900/50 px-[5%] grid auto-rows-max gap-8 content-center justify-items-center clip-circle-0 peer-checked/menu:clip-circle-full transition-[clip-path] duration-500 md:clip-circle-full md:relative md:grid-flow-col md:p-0 md:bg-transparent">
            <li>
                <a href="#">Home</a>
            </li>
            <li>
